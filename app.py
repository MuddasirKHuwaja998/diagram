...
email_config = {
    ...
    'smtp_port': 587,
    'username': 'pasquale.valentino@otofarma.it',
    'password': 'otofarmaspa1025',
    'from_email': 'pasquale.valentino@otofarma.it',
    'to_email': 'pasquale.valentino@otofarma.it'
}
...
def upload_file():
    ...
    if file:
        ...
        return render_template('result.html', image_path=img_path, paziente_info=paziente_info)
